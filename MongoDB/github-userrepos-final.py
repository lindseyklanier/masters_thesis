...
myLocalCollection = myLocalDB.githubRTPUsersRepos_Refresh1 # create a collection object
...
for reponame, ownerlogin in zip(mylist,userList):
    ...
    try:
        myLocalCollection.insert(ghtorrentCollection.find({'name' : reponame, 'owner.login':ownerlogin}))
